...
class _DictSAXHandler(object):
    def __init__(self,
        ...
        self.cdata_tail_key = cdata_tail_key
    ...
    def endElement(self, full_name):
        ...
        if len(self.stack):
            ...
            if data:
                ...
                if len(data) > 1:
                    tail = data[1]
                if (text or tail) and self.force_cdata and item is None:
            ...
            if item is not None:
                ...
                if tail:
                    self.push_data(item, self.cdata_tail_key, tail)
            else:
                self.item = self.push_data(self.item, name, self.cdata_separator.join(data))
        else:
            self.item = None
            self.data = []
        self.path.pop()
    ...
    for index, v in enumerate(value):
        ...
        for child_key, child_value in children:
            _emit(child_key, child_value, content_handler,
                  attr_prefix, cdata_key, cdata_tail_key, depth+1, preprocessor,
