...
When `reporting a bug <https://github.com/numengo/python-ngoschema/issues>`_ please include:
...
1. Fork `python-ngoschema <https://github.com/numengo/python-ngoschema>`_
...
.. [1] If you don't have all the necessary python versions available locally you can rely on Travis - it will
       `run the tests <https://travis-ci.org/numengo/python-ngoschema/pull_requests>`_ for each change you add in the pull request.
